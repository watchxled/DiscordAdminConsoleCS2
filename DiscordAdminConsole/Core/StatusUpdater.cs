...
public class StatusUpdater
{
    ...
    public async Task FinalizeAsync()
    {
        ...
        foreach (var tracked in await _store.GetStatusMessagesAsync())
        {
            ...
            var embed = new EmbedBuilder()
                .WithTitle(server?.Name ?? _loc.Get("status.server"))
                ...
                .AddField(_loc.Get("status.map"), "-", true)
                .AddField(_loc.Get("status.players"), "-", true)
                .WithFooter(_loc.Get("status.offlineFooter"))
                .Build();
    ...
    public async Task<Embed> BuildStatusEmbedAsync(ServerEntry server)
    {
        ...
        var builder = new EmbedBuilder()
            ...
            .AddField(_loc.Get("status.map"), info != null ? info.Map : "-", true)
            .AddField(_loc.Get("status.players"), info != null ? $"{players}/{maxPlayers}" : "-", true)
            .WithFooter(_loc.Format("status.updatedFooter", $"{DateTime.UtcNow:HH:mm:ss}"));
