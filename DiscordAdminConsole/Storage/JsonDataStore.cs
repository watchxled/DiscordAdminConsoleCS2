...
public class JsonDataStore : IDataStore
{
    ...
    private void SeedIfEmpty()
    {
        if (_flags.Flags.Count == 0)
        {
            ...
            {
                new FlagRecord { Name = SystemFlags.PlayerKick, Description = "Kick players" },
                new FlagRecord { Name = SystemFlags.PlayerBan, Description = "Ban/unban" },
                new FlagRecord { Name = SystemFlags.PlayerMute, Description = "Mute/gag/silence" },
    ...
    {
        Cmd("ban", "Ban", "🔨", "Ban the player", SystemFlags.PlayerBan,
            "css_ban {PLAYER} {TIME} \"{REASON}\"", "mm_ban {STEAMID} {TIME_SECONDS} \"{REASON}\""),
        Cmd("mute", "Mute", "🔇", "Mute the player", SystemFlags.PlayerMute,
            "css_mute {PLAYER} {TIME}", "mm_mute {STEAMID} {TIME_SECONDS} \"{REASON}\""),
        Cmd("gag", "Gag", "🔇", "Gag the player", SystemFlags.PlayerMute,
            "css_gag {PLAYER} {TIME}", "mm_gag {STEAMID} {TIME_SECONDS} \"{REASON}\""),
        Cmd("silence", "Silence", "🔇", "Mute + gag", SystemFlags.PlayerMute,
            "css_silence {PLAYER} {TIME}", "mm_silence {STEAMID} {TIME_SECONDS} \"{REASON}\""),
        Cmd("unban", "Unban", "♻️", "Unban by SteamID", SystemFlags.PlayerBan,
            "css_unban {STEAMID}", "mm_unban {STEAMID}"),
        Cmd("unmute", "Unmute", "♻️", "Unmute by SteamID", SystemFlags.PlayerMute,
            "css_unmute {STEAMID}", "mm_unmute {STEAMID}"),
        Cmd("ungag", "Ungag", "♻️", "Ungag by SteamID", SystemFlags.PlayerMute,
